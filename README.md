...
[![Latest Stable Release](https://img.shields.io/github/v/release/pkgforge-dev/REDRIVER2-AppImage)](https://github.com/pkgforge-dev/REDRIVER2-AppImage/releases/latest)

<p align="center">
  <img src="https://github.com/OpenDriver2/REDRIVER2/blob/master/.flatpak/icon.png" width="128" />
</p>
...
### ⚠️ Follow [instructions](https://github.com/OpenDriver2/REDRIVER2/wiki/Installation-instructions) to extract assets and move `DRIVER2` directory to `~./driver` ⚠️
